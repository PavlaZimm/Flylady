...
export default function AboutPage() {
  return <main className="max-w-3xl space-y-7">
    ...
    <section className="space-y-3"><h2 className="text-xl font-semibold">Kdo za webem stojí</h2><p>Pavla Zimmermannová, Bílina.</p></section>
    ...
    <section className="space-y-3"><h2 className="text-xl font-semibold">Jak připravujeme články</h2><p>Průvodce vydává redakce Flylady.cz. Konkrétní informace o místech a nabídkách ověřujeme u pořadatelů a odkazujeme na zdroje. U podstatně přepracovaných článků uvádíme datum aktualizace. Datované cenové příklady v článcích se nemusí shodovat s aktuální nabídkou.</p><p>Průvodci pomáhají s výběrem a nenahrazují pokyny provozovatele. Osobní recenzi odlišujeme od přehledu vytvořeného z veřejných podkladů.</p></section>
